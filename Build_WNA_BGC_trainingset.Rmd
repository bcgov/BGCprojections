...
# Project elev to Albers (same as bgcs).
elev <- project(elev, bgcs)
...
coords_train <- subsetByExtent(coords, trainingarea, crs = "EPSG:3005")

#### This does not work yet - "No points left after cropping to cropExt. Do projections match?Error: [as.data.frame] geom="XY" is only valid for point geometries. Maybe this has something to do with me renaming lon and lat to x and y? Or maybe because coords is a data table instead of a spatial object?
...
studyarea <- ext(c(-123, -117, 49, 525))
