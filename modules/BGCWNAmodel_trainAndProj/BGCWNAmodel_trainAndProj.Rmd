---
title: "BGCWNAmodel_trainAndProj Manual"
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'BGCWNAmodel_trainAndProj', path = '..')$version`"
...
editor_options:
  ...
  bibliography: citations/references_BGCWNAmodel_trainAndProj.bib
link-citations: true
always_allow_html: true
---

# BGCWNAmodel_trainAndProj Module

<!-- the following are text references used in captions for LaTeX compatibility -->
(ref:BGCprojections-dataPrep) *BGCWNAmodel_trainAndProj*
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "BGCWNAmodel_trainAndProj", path = '..')$authors), sep = ', ')`
...
If `sourceURL` is specified, `downloadData("BGCWNAmodel_trainAndProj", "C:/Users/cbarros/GitHub/BCGov/CCISS/SpaDES/modules")` may be sufficient.
...
df_inputs <- SpaDES.core::moduleInputs("BGCWNAmodel_trainAndProj", "C:/Users/cbarros/GitHub/BCGov/CCISS/SpaDES/modules")
...
df_params <- SpaDES.core::moduleParams("BGCWNAmodel_trainAndProj", "C:/Users/cbarros/GitHub/BCGov/CCISS/SpaDES/modules")
...
df_outputs <- SpaDES.core::moduleOutputs("BGCWNAmodel_trainAndProj", "C:/Users/cbarros/GitHub/BCGov/CCISS/SpaDES/modules")
